							...
							<CardContent className='space-y-4'>
								<div className='bg-muted/50 border rounded-md p-4'>
									<div className='flex justify-between items-center'>
										...
										<Badge className='bg-brand-purple/10 text-brand-purple border-brand-purple/20'>Active</Badge>
									</div>
											...
											<CardContent className='text-sm'>
												<ul className='space-y-2'>
													<li className='flex items-center'>
														<Check className='h-4 w-4 mr-2 text-green-500' />5 AI images per month
													</li>
