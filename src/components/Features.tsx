    ...
    <section className="py-20 px-6 bg-muted/50">
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Transform Your Marketing Content</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Feature 1 */}
          <div className="bg-background rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow">
          ...
          <div className="bg-background rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow">
            ...
            <p className="text-muted-foreground">Create beautiful marketing images with OpenAI's DALL·E 3 technology</p>
          </div>
          ...
          <div className="bg-background rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow">
            ...
            <p className="text-muted-foreground">Transform images into engaging videos with Kling AI's technology</p>
          </div>
          ...
          <div className="bg-background rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow">
            ...
            <p className="text-muted-foreground">Add professional voiceovers with ElevenLabs' voice synthesis</p>
          </div>
