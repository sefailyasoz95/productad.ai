			...
			<div className='container mx-auto max-w-6xl'>
				<div className='text-center mb-16'>
					...
					<p
						...
						ProductAd combines multiple AI technologies to create powerful promotional content that converts - all
				...
				<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
					{/* Feature 1 */}
					<div
						className='bg-background rounded-lg p-6 shadow-md hover:shadow-lg transition-all hover:scale-105 animate-fade-in'
						style={{ animationDelay: "0.2s" }}>
						...
						<p className='text-muted-foreground'>
							Upload your product image, add a description and watch AI do the rest
						</p>
					</div>
