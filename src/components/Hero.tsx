    ...
    <section className="pt-32 pb-20 md:pt-40 md:pb-32 px-6 relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-12">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto mb-8 opacity-0 animate-fade-in" style={{animationDelay: "0.3s"}}>
          ...
          <div className="flex justify-center opacity-0 animate-fade-in" style={{animationDelay: "0.5s"}}>
            <Dialog>
              <DialogTrigger asChild>
                <Button size="lg" className="bg-gradient-to-r from-brand-purple to-brand-blue hover:opacity-90 transition-all hover:scale-105">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
          <div className="glass-card dark:glass-card-dark rounded-lg p-6 text-center flex flex-col items-center transform transition-all hover:scale-105 opacity-0 animate-fade-in" style={{animationDelay: "0.6s"}}>
          ...
          <div className="glass-card dark:glass-card-dark rounded-lg p-6 text-center flex flex-col items-center transform transition-all hover:scale-105 opacity-0 animate-fade-in" style={{animationDelay: "0.7s"}}>
          ...
          <div className="glass-card dark:glass-card-dark rounded-lg p-6 text-center flex flex-col items-center transform transition-all hover:scale-105 opacity-0 animate-fade-in" style={{animationDelay: "0.8s"}}>
            <div className="w-12 h-12 rounded-full bg-brand-purple/20 flex items-center justify-center mb-4">
