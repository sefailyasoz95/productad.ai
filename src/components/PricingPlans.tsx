				...
				<div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
					...
					<div className='bg-background rounded-lg overflow-hidden shadow-lg border border-border'>
						...
						<div className='p-6'>
							...
							<Button className='w-full mt-8 bg-gradient-to-r from-brand-purple to-brand-blue'>Choose Plus</Button>
						</div>
					</div>
					...
					<div className='bg-background rounded-lg shadow-xl border border-brand-purple/30 relative transform z-10'>
						<div className='absolute -top-3.5 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-brand-purple to-brand-blue text-white px-4 py-1 rounded-full text-sm font-medium'>
							Most Popular
						</div>
						...
						<div className='p-6'>
							...
							<Button className='w-full mt-8 bg-gradient-to-r from-brand-purple to-brand-blue'>Choose Pro Max</Button>
						</div>
					</div>
				</div>
			</div>
