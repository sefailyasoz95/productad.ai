...
const Footer = () => {
	return (
		<footer className='bg-muted/60 py-12 px-6'>
			<div className='container mx-auto max-w-6xl'>
				<div className='grid grid-cols-2 w-full'>
					{/* Brand */}
					<div className='col-span-1 md:col-span-1'>
						<Link to='/' className='inline-block mb-4'>
							<span className='font-bold text-2xl gradient-text'>ProductAd</span>
						</Link>
						<p className='text-muted-foreground mb-4'>Create. Influence. Sell. Instantly.</p>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/contact" className="text-muted-foreground hover:text-foreground">Contact</Link></li>
				...
				<div className='border-t border-border mt-12 pt-8 text-center text-muted-foreground'>
					<p>&copy; {new Date().getFullYear()} ProductAd. All rights reserved.</p>
				</div>
			</div>
		</footer>
	);
